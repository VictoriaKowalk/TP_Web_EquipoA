...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <br />
   <div id="carouselPromos" class="carousel slide"  data-bs-ride="carousel" data-bs-interval="2500">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="img/Promo1.png" style="height: 300px; width: 100%; object-fit: contain;" class="d-block " alt="Promo 1">
            </div>
            <div class="carousel-item ">
                <img src="img/Promo2.png" style="height: 300px; width: 100%; object-fit: contain;" class="d-block " alt="Promo 2">
            </div>
            <div class="carousel-item">
                <img src="img/Promo3.png" style="height: 300px; width: 100%; object-fit: contain;" class="d-block " alt="Promo 3">
            </div>
            <div class="carousel-item">
                <img src="img/Promo4.png" style="height: 300px; width: 100%; object-fit: contain;" class="d-block " alt="Promo 4">
            </div>
            <div class="carousel-item">
                <img src="img/Promo5.png" style="height: 300px; width: 100%; object-fit: contain;" class="d-block " alt="Promo 5">
            </div>
        </div>
